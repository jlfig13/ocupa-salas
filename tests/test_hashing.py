...
def test_deterministico_e_insensivel_a_ordem():
    a = {"idReserva": 1, "idSituacao": 3, "cnpj_empresa": "22.222.222/0001-22"}
    b = {"cnpj_empresa": "22.222.222/0001-22", "idSituacao": 3, "idReserva": 1}
    assert hash_linha(a) == hash_linha(b)


def test_muda_com_qualquer_escalar():
    base = {"idReserva": 1, "idSituacao": 1}
    assert hash_linha(base) != hash_linha({**base, "idSituacao": 4})
